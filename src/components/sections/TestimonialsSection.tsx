      ...
      <div className="container mx-auto px-4">
        ...
        <div className="relative">
          <Carousel className="w-full max-w-5xl mx-auto">
            ...
            <CarouselPrevious className="absolute top-1/2 -translate-y-1/2 left-0 transform -translate-x-[120%] !h-12 !w-12 bg-gradient-to-r from-purple-500 to-purple-600 border-none text-white hover:opacity-90 hover:scale-110 transition-all duration-300 shadow-lg hover:shadow-purple-500/25" />
            <CarouselNext className="absolute top-1/2 -translate-y-1/2 right-0 transform translate-x-[120%] !h-12 !w-12 bg-gradient-to-r from-green-400 to-green-500 border-none text-white hover:opacity-90 hover:scale-110 transition-all duration-300 shadow-lg hover:shadow-green-500/25" />
          </Carousel>
        </div>
